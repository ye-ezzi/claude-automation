...
KEYWORD_TREE = [
    ...
    },
    {
        ...
        "modifiers": ["고퀄리티", "바로 복붙", "업무용", "이미지 생성", "한국어로", "무료 공개"],
    ...
    },
    {
        "root": "AI로 직접 만들기",
        "tier": 1,
        "engine_fit": ["Claude", "ChatGPT"],
        "modifiers": ["바이브코딩으로", "코딩 몰라도", "1인 브랜드용", "프리랜서가", "디자이너가",
                      "자동화", "코딩 한줄 없이", "인터랙티브 아트", "Claude로"],
        "angles":    ["포트폴리오 사이트", "예약 페이지", "자동화 봇", "랜딩 페이지", "수익화 방법"],
        "used_subs": [],
    },
]
